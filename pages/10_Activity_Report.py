...
lc = get_content("activity_report")

learning_callout(
    "Why Audit Trails Matter",
    "An audit trail provides **non-repudiation** (you can't deny an action), "
    "**accountability** (every change has an owner), and **segregation of duties "
    "evidence** (different people performed different steps). ISO 27001 A.8.15 "
