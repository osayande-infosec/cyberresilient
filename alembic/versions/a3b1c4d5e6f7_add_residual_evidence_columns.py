...
down_revision: str | Sequence[str] | None = "92af1072f7ec"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("risks") as batch_op:
        batch_op.add_column(sa.Column("residual_score", sa.Float(), nullable=True))
        batch_op.add_column(sa.Column("mitigation_effectiveness", sa.String(20), server_default="None", nullable=False))
        batch_op.add_column(sa.Column("evidence_date", sa.String(20), server_default="", nullable=False))
        batch_op.add_column(sa.Column("sign_off_by", sa.String(100), server_default="", nullable=False))
    ...
    with op.batch_alter_table("policies") as batch_op:
        batch_op.add_column(sa.Column("review_alert_sent", sa.Integer(), server_default="0", nullable=False))
